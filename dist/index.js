...
var UpStamps = /** @class */ (function () {
    function UpStamps(_a) {
        var clientId = _a.clientId, projectKey = _a.projectKey, envKey = _a.envKey, _b = _a.endpoint, endpoint = _b === void 0 ? apiUrl : _b;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        url = this.endpoint + "/" + this.clientId + "/" + this.projectKey + "/scopes/add";
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        url = this.endpoint + "/" + this.clientId + "/" + this.projectKey + "/" + this.envKey + "/flags";
                        return [4 /*yield*/, fetch(url)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.json()];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        url = this.endpoint + "/" + this.clientId + "/" + this.projectKey + "/" + this.envKey + "/remotes";
                        return [4 /*yield*/, fetch(url)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.json()];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        variantTypes_1 = ["A", "B"];
                        url_1 = this.endpoint + "/" + this.clientId + "/" + this.projectKey + "/" + this.envKey + "/testing";
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        url = this.endpoint + "/" + this.clientId + "/" + this.projectKey + "/" + this.envKey + "/segment";
                        query = queryBuilder({
                            name: name,
